...
KSC_folder_path = 'Research_2024_GEN/Generate_with_Prompt/KSC'
Normal_folder_path_3 = 'Research_2024_GEN/Not_Redundancy/GPT3.5/Normal'
Specific_folder_path_3 = 'Research_2024_GEN/Not_Redundancy/GPT3.5/Specific'
Normal_folder_path_4 = 'Research_2024_GEN/Not_Redundancy/GPT4/Normal'
Specific_folder_path_4 = 'Research_2024_GEN/Not_Redundancy/GPT4/Specific'

concept_folder_path = 'Concept_Data'
file_names = os.listdir(Normal_folder_path_3)
...
for file_name in file_names:
    for i in range(0, 16):
        if file_name.endswith('.json') and list(concept_count.keys())[i] in file_name:
            KSC_file_path = os.path.join(KSC_folder_path, file_name)
            Normal_file_path_3 = os.path.join(Normal_folder_path_3, file_name)
            Specific_file_path_3 = os.path.join(Specific_folder_path_3, file_name)
            Normal_file_path_4 = os.path.join(Normal_folder_path_4, file_name)
            Specific_file_path_4 = os.path.join(Specific_folder_path_4, file_name)
            concept_file_path = os.path.join(concept_folder_path, file_name)
            
            KSC_file = read_json_file(KSC_file_path)['train']
            ...
            KSC_count[list(KSC_count.keys())[i]] += len(KSC_file)
