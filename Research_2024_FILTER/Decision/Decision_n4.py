...
candidate_folder_path = 'Generated_Data/Gen_N4'
selected_folder_path = 'Selected_Data/Selected_N4'
...
for file_name in prompt_file_names:
    ...
    if file_name.endswith('.json'):
        ...
        for i in range(len(candidate['train'])):
            input_n4_str += example + str(candidate['train'][i]) + prompt_question
...
save_json_file(input_n4_str, f'input_n4.json')
save_json_file(output_n4_str, f'output_n4.json')
