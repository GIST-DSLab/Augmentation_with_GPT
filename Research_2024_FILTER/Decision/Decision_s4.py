...
candidate_folder_path = 'Generated_Data/Gen_S4'
selected_folder_path = 'Selected_Data/Selected_S4'
...
for file_name in prompt_file_names:
    ...
    if file_name.endswith('.json'):
        ...
        for i in range(len(candidate['train'])):
            input_s4_str += example + str(candidate['train'][i]) + prompt_question
...
save_json_file(input_s4_str, f'input_s4.json')
save_json_file(output_s4_str, f'output_s4.json')
